...
import FlightDetailsSidebar from "./FlightDetailsSidebar";
import FareCard from "./FareCard"; // Assuming FareCard is in the same directory
  ...
  return (
    <>
      <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
        ...
        {/* Action Bar with both buttons */}
        <div className="border-t border-gray-100 bg-gray-50/70 px-4 py-3 flex flex-col sm:flex-row items-center justify-between gap-3">
          <button
            onClick={() => setShowDetails(true)}
            className="text-blue-600 hover:underline text-sm font-medium transition-colors"
          >
